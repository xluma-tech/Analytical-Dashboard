        ...
        <div className="space-y-6 animate-in fade-in duration-500 pb-10 relative">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-4 gap-6 relative z-10">
                ...
                <div className="xl:col-span-3 space-y-6">
                    ...
                    <ScrollAnimation className="h-[500px]" delay={0.1}>
                        <CompaniesTable />
                    </ScrollAnimation>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <ScrollAnimation delay={0.2}>
                            <Card className="bg-surface-deep/50 border-white/5 backdrop-blur-md p-6 relative overflow-hidden group h-full">
                        ...
                        <ScrollAnimation delay={0.3}>
                            <Card className="bg-surface-deep/50 border-white/5 backdrop-blur-md p-6 h-full">
                    ...
                    <ScrollAnimation className="h-64" delay={0.4}>
                ...
                <div className="xl:col-span-1 space-y-6">
                    ...
                    <ScrollAnimation className="grid grid-cols-3 gap-2" delay={0.6}>
                        {[
                    ...
                    {/* Recent Activity */}
                    <ScrollAnimation className="bg-surface-deep/50 rounded-2xl border border-white/5 backdrop-blur-md p-6" delay={0.8}>
